#i followed a tutorial to simply detect a hand on a screen!
#as of now (2.28.23), it may not work but the video i followed is in the readme!
...
while(cap.isOpened()):
    #reading the image
    ret, img = cap.read()
    # understanding the hand from the rectangle
    cv2.rectangle(img, (300,300), (100,100), (0,255,0),0)
    crop_img = img[100:300, 100:300]

    # grey image from color
